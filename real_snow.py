...
def add_material(obj: bpy.types.Object):
    ...
    principled.inputs[9].default_value = (1.0, 1.0, 1.0)          # Subsurface scale - 修改：改为向量 (NodeSocketVector)
    principled.inputs[8].default_value = 0.36    # Subsurface radius - 改回单个浮点值 (NodeSocketFloatFactor)
